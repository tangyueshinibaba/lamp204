...
@section('content')
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/carousel/update/{{$data->id}}" enctype="multipart/form-data"> 
    {{ csrf_field() }} 
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea class="input" name="describe" style=" height:90px;">{{$data->describe}}</textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
