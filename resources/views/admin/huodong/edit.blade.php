...
@section('content')
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/adminhd/update/{{$data->id}}" enctype="multipart/form-data"> 
    {{ csrf_field() }} 
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="{{$data->pname}}" name="pname" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea class="input" name="jieshao" style="width:25%; height:90px;">{{$data->jieshao}}</textarea>
        </div>
      </div>
      <div class="form-group">
        <div class="label">
