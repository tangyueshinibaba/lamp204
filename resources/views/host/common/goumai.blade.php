...
<script type="text/javascript" src="/common/host/js/jquery-1.8.3.min.js"></script>
...
<div class="clear wrapper header">
    <div class="logo float-lt" style="margin-right:130px;"><img src="/common/host/images/logo.png" width="193" height="97" /></div>
...
<div class="fri-link-bg">
    <div class="fri-link">
        <div class="logo float-lt margin-r20"><img src="/common/host/images/fo-logo.jpg" width="152" height="81" /></div>
        <div class="float-lt"><img src="/common/host/images/qd.jpg" width="90"  height="90" />
            <p>扫描下载APP</p>
        </div>
